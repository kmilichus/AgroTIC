...
@Repository
@Scope("singleton")
public class FaseaplicadaHome implements IFaseAplicadaDAO{

	private static final Log log = LogFactory.getLog(FaseaplicadaHome.class);
	...
	public Faseaplicada merge(Faseaplicada detachedInstance) {
		...
		try {
			Faseaplicada result = (Faseaplicada) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Faseaplicada findById(BigDecimal id) {
		...
		try {
			Faseaplicada instance = (Faseaplicada) sessionFactory.getCurrentSession()
	...
	public List<Faseaplicada> findByExample(Faseaplicada instance) {
		...
		try {
			List<Faseaplicada> results = (List<Faseaplicada>) sessionFactory.getCurrentSession()
